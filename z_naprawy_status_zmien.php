...
if (strlen($noweuwagi)>2) {
	$sql_e1="UPDATE $dbname.serwis_naprawa SET naprawa_status = '$_POST[stat]', naprawa_osoba_wysylajaca  = '$_POST[ow]', naprawa_data_wysylki = '$_POST[dw]', naprawa_fs_nazwa = '$_POST[tfs]', naprawa_fk_nazwa = '$_POST[tfk]', naprawa_nr_listu_przewozowego = '$_POST[tnlp]', naprawa_przewidywany_termin_naprawy = '$_POST[ttn] 23:59:59', naprawa_uwagi='".nl2br($noweuwagi)."', naprawa_uwagi_sa='1' WHERE naprawa_id='$_POST[uid]' LIMIT 1";
} else {
	$sql_e1="UPDATE $dbname.serwis_naprawa SET naprawa_status = '$_POST[stat]', naprawa_osoba_wysylajaca  = '$_POST[ow]', naprawa_data_wysylki = '$_POST[dw]', naprawa_fs_nazwa = '$_POST[tfs]', naprawa_fk_nazwa = '$_POST[tfk]', naprawa_nr_listu_przewozowego = '$_POST[tnlp]', naprawa_przewidywany_termin_naprawy = '$_POST[ttn] 23:59:59', naprawa_uwagi='', naprawa_uwagi_sa='0' WHERE naprawa_id='$_POST[uid]' LIMIT 1";
}
//echo $sql_e1;
