...
switch ($_GET[element]) {
	case "tresc" : 	pageheader("Edycja treści zgłoszenia numer <b>$_GET[nr]</b>"); 
					...
					break;
	case "osoba" : 	pageheader("Edycja osoby zgłaszającej dla zgłoszenia numer <b>$_GET[nr]</b>"); 
					...
					list($value_to_change,$value_to_change_2)=mysql_fetch_array($result);
					break;
	case "czas_zak" : pageheader("Edycja czasu rozpoczęcia realizacji zgłoszenia numer <b>$_GET[nr]</b>"); 
...
tr_();
	...
	td_(";t;");
		echo "<b>".substr($value_to_change,0,16)."</b>";
	_td();
_tr();
