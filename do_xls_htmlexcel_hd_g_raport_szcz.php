...
if ($_POST[do_punktu]=='1') $sql_query = "SELECT zgl_nr, zgl_poczta_nr, zgl_data, zgl_godzina, zgl_komorka, zgl_osoba, zgl_temat, zgl_tresc, hd_kategoria_opis, hd_podkategoria_opis, hd_priorytet_opis, zgl_status, hd_status_opis, zgl_razem_czas FROM $dbname_hd.hd_zgloszenie, $dbname_hd.hd_kategoria, $dbname_hd.hd_podkategoria, $dbname_hd.hd_priorytet, $dbname_hd.hd_status WHERE (zgl_data BETWEEN '$_POST[start_date]' and '$_POST[end_date]') and (zgl_kategoria=hd_kategoria_nr) and (zgl_podkategoria=hd_podkategoria_nr) and (zgl_priorytet=hd_priorytet_nr) and (zgl_status=hd_status_nr) and (zgl_widoczne=1) and (zgl_kategoria<>5) ORDER BY zgl_data ASC";

if ($_POST[do_punktu]=='2') $sql_query = "SELECT zgl_nr, zgl_poczta_nr, zgl_data, zgl_godzina, zgl_komorka, zgl_osoba, zgl_temat, zgl_tresc, hd_kategoria_opis, hd_podkategoria_opis, hd_priorytet_opis, zgl_status, hd_status_opis, zgl_razem_czas FROM $dbname_hd.hd_zgloszenie, $dbname_hd.hd_kategoria, $dbname_hd.hd_podkategoria, $dbname_hd.hd_priorytet, $dbname_hd.hd_status WHERE (zgl_data BETWEEN '$_POST[start_date]' and '$_POST[end_date]') and (zgl_status=9) and (zgl_kategoria=hd_kategoria_nr) and (zgl_podkategoria=hd_podkategoria_nr) and (zgl_priorytet=hd_priorytet_nr) and (zgl_status=hd_status_nr) and (zgl_widoczne=1) and (zgl_kategoria<>5) ORDER BY zgl_data ASC";

if ($_POST[do_punktu]=='3') $sql_query = "SELECT zgl_nr, zgl_poczta_nr, zgl_data, zgl_godzina, zgl_komorka, zgl_osoba, zgl_temat, zgl_tresc, hd_kategoria_opis, hd_podkategoria_opis, hd_priorytet_opis, zgl_status, hd_status_opis, zgl_razem_czas FROM $dbname_hd.hd_zgloszenie, $dbname_hd.hd_kategoria, $dbname_hd.hd_podkategoria, $dbname_hd.hd_priorytet, $dbname_hd.hd_status WHERE (zgl_data BETWEEN '$_POST[start_date]' and '$_POST[end_date]') and (zgl_status<>9) and (zgl_status<>1) and (zgl_kategoria=hd_kategoria_nr) and (zgl_podkategoria=hd_podkategoria_nr) and (zgl_priorytet=hd_priorytet_nr) and (zgl_status=hd_status_nr) and (zgl_widoczne=1) and (zgl_kategoria<>5) ORDER BY zgl_data ASC";

if ($_POST[do_punktu]=='4') {
	$sql_query = "SELECT zgl_nr, zgl_poczta_nr, zgl_data, zgl_godzina, zgl_komorka, zgl_osoba, zgl_temat, zgl_tresc, hd_kategoria_opis, hd_podkategoria_opis, hd_priorytet_opis, zgl_status, hd_status_opis, zgl_razem_czas FROM $dbname_hd.hd_zgloszenie, $dbname_hd.hd_kategoria, $dbname_hd.hd_podkategoria, $dbname_hd.hd_priorytet, $dbname_hd.hd_status WHERE (zgl_kategoria=hd_kategoria_nr) and (zgl_podkategoria=hd_podkategoria_nr) and (zgl_priorytet=hd_priorytet_nr) and (zgl_status=hd_status_nr) and (zgl_data BETWEEN '2010-10-01' and '$_POST[end_date]') and (zgl_status<>9) and (zgl_status<>1) and (zgl_widoczne=1) and (zgl_kategoria<>5) ORDER BY zgl_data ASC"; 
	
	//$sql_query = "SELECT zgl_nr, zgl_poczta_nr, zgl_data, zgl_godzina, zgl_komorka, zgl_osoba, zgl_temat, zgl_tresc, hd_kategoria_opis, hd_podkategoria_opis, hd_priorytet_opis, zgl_status, hd_status_opis FROM $dbname_hd.hd_zgloszenie, $dbname_hd.hd_kategoria, $dbname_hd.hd_podkategoria, $dbname_hd.hd_priorytet, $dbname_hd.hd_status WHERE (zgl_data_rozpoczecia<>'0000-00-00 00:00:00') and (zgl_status<>9) and (SUBSTRING(zgl_data_zakonczenia,1,10)<=zgl_data_zmiany_statusu) and (zgl_kategoria=hd_kategoria_nr) and (zgl_podkategoria=hd_podkategoria_nr) and (zgl_priorytet=hd_priorytet_nr) and (SUBSTRING(zgl_data_zakonczenia,1,10) BETWEEN '$_POST[start_date]' and '$_POST[end_date]') and (zgl_status=hd_status_nr) and (zgl_widoczne=1) ORDER BY zgl_data ASC";
