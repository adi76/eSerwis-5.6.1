      ...
      if (!$('#cluetip').length) {
        $(['<div id="cluetip">',
          '<div id="cluetip-outer">',
            '<h1 style="font-weight:normal;" id="cluetip-title"></h1>',
            '<div class=h8 style="font-weight:normal; background-color:#FFFFFF; color:red; padding:0px; margin:0px; border:0px solid;" id="cluetip-inner"></div>',
          '</div>',
