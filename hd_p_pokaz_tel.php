...
<?php
	...
	//nowalinia();
	pageheader("Telefon(y) do komórki");
	...
	$r4 = mysql_query("SELECT up_telefon FROM $dbname.serwis_komorki WHERE ((belongs_to=$es_filia) and (up_active=1) and (up_id=$_upid)) LIMIT 1", $conn) or die($k_b);
