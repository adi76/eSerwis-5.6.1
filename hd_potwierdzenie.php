...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <span class="style34">Raport ze zgłoszenia nr:<?php if ($_REQUEST[nr]!='') { echo "&nbsp;$_REQUEST[nr]"; } else { echo "<font style='font-weight:normal'>&nbsp;......................</font>"; } ?>
      </span>
	...
	<?php /*  <br />
	  <span class="style8">Data:&nbsp;
	  <?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";//echo "$_REQUEST[dzien]"; ?>/<?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";//echo "$_REQUEST[miesiac]"; ?>/<?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";//echo "$_REQUEST[rok]"; ?>&nbsp;
      </span> 
	<br /><br /><span class="style8">Godzina:&nbsp;..........................
      </span> 
	  */ 
	  ?>
	  </td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">	
    ...
    <tr>
      <td height="auto" align="left" valign="top" class="style44"><span class="style8x">&nbsp;Wykonane czynności </span></td>
	  
<?php
	if ($_REQUEST[nr]!="") { 

		$sql="SELECT zgl_szcz_nr_kroku,zgl_szcz_czas_rozpoczecia_kroku,zgl_szcz_status,zgl_szcz_wykonane_czynnosci,zgl_szcz_widoczne FROM $dbname_hd.hd_zgloszenie_szcz WHERE (zgl_szcz_zgl_id=$_REQUEST[id])"; // and (belongs_to=$es_filia)";	
		$result = mysql_query($sql, $conn_hd) or die($k_b);
...
?>
    ...
    <tr>
      <td height="auto" align="left" valign="top" class="style44"><span class="style8x">&nbsp;Uwagi</span></td>
      <td colspan="4" align="left" valign="top" class="style45"><span class="style34x"></span></td>
    </tr>
</table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
