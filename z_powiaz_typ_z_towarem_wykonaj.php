...
<body>
<?php 
$sql_d1="UPDATE $dbname_hd.hd_zgl_wymiany_podzespolow SET wp_wskazanie_sprzetu_z_magazynu=1, wp_sprzedaz_fakt_szcz_id=$_REQUEST[wyb_fszcz_id], wp_typ_podzespolu='' WHERE (wp_id='$_REQUEST[wpid]') LIMIT 1";

if (mysql_query($sql_d1, $conn_hd)) { 
	?><script>
	if (opener.opener) opener.opener.location.reload(true);
